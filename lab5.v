/*
 * Student A		Deepansh Agrawal
 * Student B		Mehul Mandviya 
 * EECE 343, Fall 2016
 * Lab 5
 */

// Do not modify the definition of the lab5 module except to change an output type (reg/wire).
module lab5(input clk, rst_n, input [17:0] SW, input action_n, output reg[6:0] HEX7, HEX6, HEX5, HEX4, HEX2, HEX1, HEX0, output reg [3:0] LEDG);
